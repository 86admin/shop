...
<body>
	<div id="site-nav">
		...
		<?php $_from = $this->_var['row']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_92666000_1506171028');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_92666000_1506171028']):
?>
		<?php if ($this->_var['row_0_92666000_1506171028']['send_start_date'] < $this->_var['time'] && $this->_var['row_0_92666000_1506171028']['send_end_date'] > $this->_var['time']): ?>
